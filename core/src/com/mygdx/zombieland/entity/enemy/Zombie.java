...
//  ===================================================================================================
        ...
        while ((endLocation.x != startLocation.x || endLocation.y != startLocation.y) && startLocation.distance(endLocation) >= 1) {
            Vector2D vec = paths.get((int) endLocation.x, (int) endLocation.y);
            if (vec == null) break;
